            ...
            {socialIcons.map((item) => (
              <li key={item}>
                <a to={item} className="group">
                  <div className="w-[40px] h-[40px]  items-center border border-white rounded-[50%]">
                    {item === "facebook" ? (
                      <FaFacebookF className="   group-hover:text-primary transition-all duration-200" />
                    ) : item === "twitter" ? (
                      <FaTwitter className="  items-center  group-hover:text-primary transition-all duration-200" />
                    ) : (
